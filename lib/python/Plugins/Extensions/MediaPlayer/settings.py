...
def Load_defaults():
    ...
    config.mediaplayer.onPluginList = ConfigYesNo(default=True)
...
class MediaPlayerSettings(Screen, ConfigListScreen):
    ...
    def initConfigList(self, element = None):
        ...
        try:
            ...
            self.list.append(getConfigListEntry(_('show mediaplayer on plugin list'), config.mediaplayer.onPluginList))
